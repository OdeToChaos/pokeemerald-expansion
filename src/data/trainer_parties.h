...
static const struct TrainerMonNoItemCustomMoves sParty_Felix[] = {
    ...
    .moves = {MOVE_PSYCHIC, MOVE_ZEN_HEADBUTT, MOVE_DISABLE, MOVE_THUNDER_PUNCH}
    },
    {
    .iv = 0,
    .lvl = 43,
    .species = SPECIES_MEOWSTIC,
    .moves = {MOVE_PSYCHIC, MOVE_DISARMING_VOICE, MOVE_PSYSHOCK, MOVE_REFLECT}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Dusty1[] = {
    ...
    .moves = {MOVE_POISON_STING, MOVE_FEINT_ATTACK, MOVE_SAND_ATTACK, MOVE_ACROBATICS}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Chip[] = {
    ...
    .moves = {MOVE_DIG, MOVE_SAND_TOMB, MOVE_YAWN, MOVE_BITE}
    },
    {
    .iv = 50,
    .lvl = 27,
    ...
    .moves = {MOVE_DOUBLE_KICK, MOVE_MUD_SHOT, MOVE_SWORDS_DANCE, MOVE_QUICK_ATTACK}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Ricky1[] = {
    ...
    .moves = {MOVE_SHADOW_SNEAK, MOVE_SCRATCH, MOVE_ASTONISH, MOVE_COPYCAT}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Braxton[] = {
    ...
    .moves = {MOVE_OMINOUS_WIND, MOVE_GIGA_DRAIN, MOVE_ICY_WIND, MOVE_STUN_SPORE}
    },
    {
    .iv = 100,
    .lvl = 28,
    .species = SPECIES_MARSHTOMP,
    .moves = {MOVE_ROCK_SLIDE, MOVE_MUD_BOMB, MOVE_DIG, MOVE_WATER_PULSE}
    },
    {
    .iv = 100,
    .lvl = 28,
    .species = SPECIES_SCIZOR,
    .moves = {MOVE_METAL_CLAW, MOVE_AGILITY, MOVE_RAZOR_WIND, MOVE_SLASH}
    },
    {
    .iv = 100,
    .lvl = 28,
    .species = SPECIES_SUNFLORA,
    .moves = {MOVE_GIGA_DRAIN, MOVE_LEECH_SEED, MOVE_GROWTH, MOVE_SOLAR_BEAM}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Jessica1[] = {
    ...
    .moves = {MOVE_PLAY_NICE, MOVE_ROLLOUT, MOVE_DISABLE, MOVE_ICE_BEAM}
    },
    {
    .iv = 0,
    .lvl = 29,
    .species = SPECIES_ARBOK,
    .moves = {MOVE_IRON_TAIL, MOVE_SCREECH, MOVE_GLARE, MOVE_CRUNCH}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Beau[] = {
    ...
    .moves = {MOVE_ROLLOUT, MOVE_TACKLE, MOVE_ODOR_SLEUTH, MOVE_ROCK_TOMB}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Edward[] = {
    ...
    .moves = {MOVE_SKETCH, MOVE_NONE, MOVE_NONE, MOVE_NONE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Sidney[] = {
    ...
    .species = SPECIES_MUK_ALOLAN,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_CRUNCH, MOVE_SCREECH, MOVE_GUNK_SHOT, MOVE_ACID_ARMOR}
    },
    {
    .iv = 250,
    .lvl = 49,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PLAY_ROUGH, MOVE_SWAGGER, MOVE_DRAIN_PUNCH, MOVE_SUCKER_PUNCH}
    },
    {
    .iv = 255,
    .lvl = 50,
...
static const struct TrainerMonItemCustomMoves sParty_Phoebe[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHADOW_BALL, MOVE_REFLECT, MOVE_WILL_O_WISP, MOVE_HEX}
    },
    {
    .iv = 250,
    .lvl = 50,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DARK_PULSE, MOVE_SHADOW_BALL, MOVE_TORMENT, MOVE_DESTINY_BOND}
    },
    {
    .iv = 255,
    .lvl = 51,
...
static const struct TrainerMonItemCustomMoves sParty_Glacia[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HAIL, MOVE_PSYCHIC, MOVE_FREEZE_DRY, MOVE_TRICK_ROOM}
    },
    {
    .iv = 250,
    .lvl = 52,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ICE_BEAM, MOVE_ACID_ARMOR, MOVE_FLASH_CANNON, MOVE_WEATHER_BALL}
    },
    {
    .iv = 250,
    .lvl = 52,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ANCIENT_POWER, MOVE_BLIZZARD, MOVE_EARTHQUAKE, MOVE_CURSE}
    },
    {
    .iv = 250,
    .lvl = 53,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HAIL, MOVE_BLIZZARD, MOVE_SHADOW_BALL, MOVE_REFLECT}
    },
    {
    .iv = 250,
    .lvl = 53,
...
static const struct TrainerMonItemCustomMoves sParty_Drake[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DRAGON_DANCE, MOVE_DRAGON_RUSH, MOVE_GRAV_APPLE, MOVE_IRON_DEFENSE}
    },
    {
    .iv = 250,
    .lvl = 54,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_MUDDY_WATER, MOVE_DRAGON_PULSE, MOVE_GIGA_IMPACT, MOVE_IRON_TAIL}
    },
    {
    .iv = 250,
    .lvl = 54,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DIG, MOVE_SLASH, MOVE_DRAGON_CLAW, MOVE_OUTRAGE}
    },
    {
    .iv = 250,
    .lvl = 55,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HYPER_BEAM, MOVE_DRAGON_DANCE, MOVE_DRAGON_RUSH, MOVE_FOCUS_BLAST}
    },
    {
    .iv = 250,
    .lvl = 56,
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne1[] = {
    ...
    .species = SPECIES_LARVITAR,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_BITE, MOVE_SCARY_FACE, MOVE_PAYBACK, MOVE_ROCK_TOMB}
    },
    {
    .iv = 100,
    .lvl = 13,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HEADBUTT, MOVE_FOCUS_ENERGY, MOVE_ANCIENT_POWER, MOVE_ROCK_TOMB}
    },
    {
    .iv = 100,
    .lvl = 13,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TACKLE, MOVE_ANCIENT_POWER, MOVE_SCARY_FACE, MOVE_ROCK_TOMB}
    },
    {
    .iv = 100,
    .lvl = 13,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TACKLE, MOVE_SMACK_DOWN, MOVE_SANDSTORM, MOVE_ROCK_TOMB}
    },
    {
    .iv = 200,
    .lvl = 15,
...
static const struct TrainerMonItemCustomMoves sParty_Brawly1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_METAL_CLAW, MOVE_SWORDS_DANCE, MOVE_LOW_SWEEP, MOVE_BULK_UP}
    },
    {
    .iv = 125,
    .lvl = 17,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_POISON_JAB, MOVE_LOW_KICK, MOVE_TAUNT, MOVE_BULK_UP}
    },
    {
    .iv = 150,
    .lvl = 16,
    .species = SPECIES_SCRAGGY,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HEADBUTT, MOVE_BRICK_BREAK, MOVE_SNARL, MOVE_BULK_UP}
    },
    {
    .iv = 150,
    .lvl = 18,
...
static const struct TrainerMonItemCustomMoves sParty_Wattson1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHOCK_WAVE, MOVE_CHARGE, MOVE_MUD_SHOT, MOVE_ELECTRIC_TERRAIN}
    },
    {
    .iv = 220,
    .lvl = 22,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_CHARGE, MOVE_SHOCK_WAVE, MOVE_FAKE_TEARS, MOVE_SNARL}
    },
    {
    .iv = 220,
    .lvl = 22,
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_DRAINING_KISS, MOVE_SHOCK_WAVE, MOVE_BODY_SLAM, MOVE_ELECTRIC_TERRAIN}
    },
    {
    .iv = 250,
    .lvl = 24,
...
static const struct TrainerMonItemCustomMoves sParty_Flannery1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_OVERHEAT, MOVE_WILL_O_WISP, MOVE_HEX, MOVE_SUNNY_DAY}
    },
    {
    .iv = 200,
    .lvl = 24,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_OVERHEAT, MOVE_IRON_DEFENSE, MOVE_DRAGON_CLAW, MOVE_CURSE}
    },
    {
    .iv = 250,
    .lvl = 28,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_OVERHEAT, MOVE_FIRE_FANG, MOVE_DIG, MOVE_STEALTH_ROCK}
    },
    {
    .iv = 250,
    .lvl = 29,
...
static const struct TrainerMonItemCustomMoves sParty_Norman1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_CONVERSION_2, MOVE_FACADE, MOVE_RECOVER, MOVE_TRI_ATTACK}
    },
    {
    .iv = 250,
    .lvl = 30,
    .species = SPECIES_BOUFFALANT,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FACADE, MOVE_SWORDS_DANCE, MOVE_REVERSAL, MOVE_EARTHQUAKE}
    },
    {
    .iv = 255,
    .lvl = 31,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SKILL_SWAP, MOVE_YAWN, MOVE_FACADE, MOVE_FEINT_ATTACK}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Winona1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_BRICK_BREAK, MOVE_DETECT, MOVE_ZEN_HEADBUTT, MOVE_AERIAL_ACE}
    },
    {
    .iv = 210,
    .lvl = 30,
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_SHADOW_BALL, MOVE_PHANTOM_FORCE, MOVE_PSYCHIC, MOVE_AERIAL_ACE}
    },
    {
    .iv = 250,
    .lvl = 32,
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_SCALD, MOVE_SUBSTITUTE, MOVE_AQUA_RING, MOVE_AERIAL_ACE}
    },
    {
    .iv = 255,
    .lvl = 33,
...
static const struct TrainerMonItemCustomMoves sParty_TateAndLiza1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_EARTHQUAKE, MOVE_HYPNOSIS, MOVE_HEAVY_SLAM, MOVE_CALM_MIND}
    },
    {
    .iv = 250,
    .lvl = 41,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PSYCHIC, MOVE_HYPNOSIS, MOVE_SUNNY_DAY, MOVE_DREAM_EATER}
    },
    {
    .iv = 250,
    .lvl = 42,
...
static const struct TrainerMonItemCustomMoves sParty_Juan1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TOXIC_SPIKES, MOVE_LIGHT_SCREEN, MOVE_WATER_PULSE, MOVE_SLUDGE_BOMB}
    },
    {
    .iv = 200,
    .lvl = 42,
    ...
    .species = SPECIES_AZUMARILL,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HYDRO_PUMP, MOVE_RAIN_DANCE, MOVE_AQUA_RING, MOVE_WATER_PULSE}
    },
    {
    .iv = 230,
    .lvl = 44,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ICE_BEAM, MOVE_SUPERSONIC, MOVE_SHELL_SMASH, MOVE_WATER_PULSE}
    },
    {
    .iv = 250,
    .lvl = 45,
    .species = SPECIES_SLOWKING,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_RAIN_DANCE, MOVE_PSYCHIC, MOVE_SCALD, MOVE_WATER_PULSE}
    },
    {
    .iv = 250,
    .lvl = 46,
...
static const struct TrainerMonNoItemCustomMoves sParty_KateAndJoy[] = {
    ...
    .moves = {MOVE_PAYBACK, MOVE_SWAGGER, MOVE_STRENGTH, MOVE_ROCK_SLIDE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Josh[] = {
    ...
    .moves = {MOVE_POWDER_SNOW, MOVE_GROWL, MOVE_ENCORE, MOVE_ANCIENT_POWER}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Ben[] = {
    ...
    .moves = {MOVE_BITE, MOVE_TAIL_WHIP, MOVE_COMET_PUNCH, MOVE_THUNDER_PUNCH}
    },
    {
    .iv = 150,
    .lvl = 17,
...
static const struct TrainerMonItemCustomMoves sParty_Wallace[] = {
    ...
    .species = SPECIES_KABUTOPS,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ANCIENT_POWER, MOVE_SLASH, MOVE_AQUA_TAIL, MOVE_STEALTH_ROCK}
    },
    {
    .iv = 255,
    .lvl = 57,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SWORDS_DANCE, MOVE_LIQUIDATION, MOVE_CLOSE_COMBAT, MOVE_SPIKES}
    },
    {
    .iv = 255,
    .lvl = 58,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HEAD_SMASH, MOVE_SURF, MOVE_GIGA_IMPACT, MOVE_WATERFALL}
    },
    {
    .iv = 255,
    .lvl = 58,
...
static const struct TrainerMonItemCustomMoves sParty_Dianne[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHADOW_BALL, MOVE_PSYCHIC, MOVE_CHARGE_BEAM, MOVE_LIGHT_SCREEN}
    },
    {
    .iv = 0,
    .lvl = 43,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_THUNDERBOLT, MOVE_CRUNCH, MOVE_THUNDER_WAVE, MOVE_HEADBUTT}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Heidi[] = {
    ...
    .moves = {MOVE_ICY_WIND, MOVE_MUD_BOMB, MOVE_ODOR_SLEUTH, MOVE_POWDER_SNOW}
    },
    {
    .iv = 0,
    .lvl = 22,
    .species = SPECIES_RHYHORN,
    .moves = {MOVE_BULLDOZE, MOVE_STOMP, MOVE_SCARY_FACE, MOVE_HORN_ATTACK}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Becky[] = {
    ...
    .lvl = 22,
    .species = SPECIES_RELICANTH,
    .moves = {MOVE_ANCIENT_POWER, MOVE_ROCK_TOMB, MOVE_HARDEN, MOVE_HEAD_SMASH}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_WallyVR1[] = {
    ...
    .moves = {MOVE_PSYCHIC_TERRAIN, MOVE_SACRED_SWORD, MOVE_PSYCHO_CUT, MOVE_SWORDS_DANCE}
    },
    {
    .iv = 250,
    .lvl = 45,
...
static const struct TrainerMonItemCustomMoves sParty_Athena[] = {
    ...
    .species = SPECIES_LANTURN,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_THUNDER, MOVE_THUNDER_WAVE, MOVE_CONFUSE_RAY, MOVE_SIGNAL_BEAM}
    },
    {
    .iv = 100,
    .lvl = 32,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_WATER_PULSE, MOVE_THIEF, MOVE_SLASH, MOVE_TAUNT}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Vivian[] = {
    ...
    .moves = {MOVE_THUNDER_SHOCK, MOVE_NASTY_PLOT, MOVE_SWEET_KISS, MOVE_CHARM}
    },
    {
    .iv = 100,
    .lvl = 17,
    .species = SPECIES_ELEKID,
    .moves = {MOVE_SHOCK_WAVE, MOVE_SWIFT, MOVE_LOW_KICK, MOVE_QUICK_ATTACK}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Hideo[] = {
    ...
    .moves = {MOVE_FLAME_BURST, MOVE_SMOG, MOVE_DRAGON_RAGE, MOVE_POISON_GAS}
    },
    {
    .iv = 0,
    .lvl = 25,
    .species = SPECIES_FOONGUS,
    .moves = {MOVE_FEINT_ATTACK, MOVE_INGRAIN, MOVE_MEGA_DRAIN, MOVE_ASTONISH}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Keigo[] = {
    ...
    .moves = {MOVE_TOXIC, MOVE_VENOSHOCK, MOVE_BITE, MOVE_WIDE_GUARD}
    },
    {
    .iv = 0,
    .lvl = 28,
    .species = SPECIES_WHIRLIPEDE,
    .moves = {MOVE_BUG_BITE, MOVE_POISON_TAIL, MOVE_PROTECT, MOVE_SCREECH}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Riley[] = {
    ...
    .moves = {MOVE_STRUGGLE_BUG, MOVE_BUG_BITE, MOVE_RAZOR_LEAF, MOVE_STRING_SHOT}
    },
    {
    .iv = 0,
    .lvl = 28,
    .species = SPECIES_TRUBBISH,
    .moves = {MOVE_TAKE_DOWN, MOVE_STOCKPILE, MOVE_SWALLOW, MOVE_ACID_SPRAY}
    }
};
