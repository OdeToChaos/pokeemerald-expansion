...
const struct TrainerMoney gTrainerMoneyTable[] =
{
    ...
    {TRAINER_CLASS_AQUA_LEADER, 25},
    {TRAINER_CLASS_AROMA_LADY, 15},
    {TRAINER_CLASS_RUIN_MANIAC, 15},
    {TRAINER_CLASS_INTERVIEWER, 15},
    {TRAINER_CLASS_TUBER_F, 5},
    {TRAINER_CLASS_TUBER_M, 5},
    {TRAINER_CLASS_SIS_AND_BRO, 5},
    {TRAINER_CLASS_COOLTRAINER, 115},
    {TRAINER_CLASS_HEX_MANIAC, 10},
    {TRAINER_CLASS_LADY, 55},
    {TRAINER_CLASS_BEAUTY, 25},
    {TRAINER_CLASS_RICH_BOY, 55},
    {TRAINER_CLASS_POKEMANIAC, 15},
    {TRAINER_CLASS_SWIMMER_M, 5},
    {TRAINER_CLASS_BLACK_BELT, 10},
    {TRAINER_CLASS_GUITARIST, 10},
    {TRAINER_CLASS_KINDLER, 10},
    {TRAINER_CLASS_CAMPER, 5},
    {TRAINER_CLASS_OLD_COUPLE, 15},
    {TRAINER_CLASS_BUG_MANIAC, 20},
    {TRAINER_CLASS_PSYCHIC, 10},
    {TRAINER_CLASS_GENTLEMAN, 25},
    {TRAINER_CLASS_ELITE_FOUR, 30},
    {TRAINER_CLASS_LEADER, 30},
    {TRAINER_CLASS_SCHOOL_KID, 5},
    {TRAINER_CLASS_SR_AND_JR, 10},
    {TRAINER_CLASS_POKEFAN, 25},
    {TRAINER_CLASS_EXPERT, 15},
    {TRAINER_CLASS_YOUNGSTER, 10},
    {TRAINER_CLASS_CHAMPION, 55},
    {TRAINER_CLASS_FISHERMAN, 15},
    {TRAINER_CLASS_TRIATHLETE, 15},
    {TRAINER_CLASS_DRAGON_TAMER, 15},
    {TRAINER_CLASS_BIRD_KEEPER, 10},
    {TRAINER_CLASS_NINJA_BOY, 5},
    {TRAINER_CLASS_BATTLE_GIRL, 10},
    {TRAINER_CLASS_PARASOL_LADY, 15},
    {TRAINER_CLASS_SWIMMER_F, 5},
    {TRAINER_CLASS_PICNICKER, 5},
    {TRAINER_CLASS_TWINS, 5},
    {TRAINER_CLASS_SAILOR, 10},
    {TRAINER_CLASS_COLLECTOR, 20},
    {TRAINER_CLASS_RIVAL, 20},
    {TRAINER_CLASS_PKMN_BREEDER, 15},
    {TRAINER_CLASS_PKMN_RANGER, 15},
    {TRAINER_CLASS_TEAM_MAGMA, 10},
    {TRAINER_CLASS_MAGMA_ADMIN, 15},
    {TRAINER_CLASS_MAGMA_LEADER, 25},
    {TRAINER_CLASS_LASS, 5},
    {TRAINER_CLASS_BUG_CATCHER, 5},
    {TRAINER_CLASS_HIKER, 15},
    {TRAINER_CLASS_YOUNG_COUPLE, 10},
