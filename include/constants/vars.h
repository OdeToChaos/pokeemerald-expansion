...
#define STARTER_REGION                                0x40F7 // starter selection for Ball_Room
#define LITTLEROOT_STATE                                0x40F8 // Rival Battle Ball_Room exit
#define STARTER_CHOICE                               0x40F9 // Unused Var
#define VAR_UNUSED_0x40FA                                0x40FA // Starter Var for ball room name selection
